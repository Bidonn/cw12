...
{
    /// <inheritdoc />
    public partial class dodawaniedanych : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "anna@example.com", "Anna", "Kowalska", "90010112345", "123-456-789" },
                    { 2, "piotr@example.com", "Piotr", "Nowak", "88020254321", "234-567-890" },
                    { 3, "maria@example.com", "Maria", "Wiśniewska", "92030367890", "345-678-901" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 8, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Explore the old city of Krakow", 20, "Trip to Krakow" },
                    { 2, new DateTime(2025, 9, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 9, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Enjoy the Italian capital", 15, "Trip to Rome" }
                });
